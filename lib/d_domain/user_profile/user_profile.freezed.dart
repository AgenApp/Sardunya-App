...
abstract class $UserProfileCopyWith<$Res> {
  ...
  $Res call({@HiveField(0, defaultValue: true) bool isFirst});
}
...
class _$_UserProfile extends _UserProfile {
  const _$_UserProfile(
      {@HiveField(0, defaultValue: true) required this.isFirst})
      : super._();
  ...
  @override
  String toString() {
    return 'UserProfile(isFirst: $isFirst)';
  }
...
abstract class _UserProfile extends UserProfile {
  const factory _UserProfile(
          {@HiveField(0, defaultValue: true) required final bool isFirst}) =
      _$_UserProfile;
